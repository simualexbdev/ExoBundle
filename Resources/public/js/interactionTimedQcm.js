...
//cf contenu_container_TimedQcm
var container = $('div#ujm_exobundle_interactiontimedQcmtype_choices'); // Div which contain the dataprototype
var tableChoices = $('#tableChoice'); // div which contain the choices array

var typeTimedQcm;

// TimedQcm Creation
function creationTimedQcm(expectedAnswer, response, point, comment, positionForce, addchoice, deleteChoice,edition, tTimedQcm) {

    $("#ujm_exobundle_interactiontimedQcmtype_typeTimedQcm_2").prop("checked", true);
    $("#ujm_exobundle_interactiontimedQcmtype_weightResponse").prop("checked", true);
    $('.radio').css({"display" : "inline-block", "margin-right" : "4%", "margin-top" : "1%"});

    var index; // number of choices

    typeTimedQcm = JSON.parse(tTimedQcm);
    ...
    // $("#ujm_exobundle_interactiontimedQcmtype_choices_1_label").parent().append('<span class="input-group-addon" id="basic-addon2"><a href="#" style="background-color="#FFFFFF";><i class="fa fa-font"></i></a></span>');
}

// TimedQcm Edition
function creationTimedQcmEdit(expectedAnswer, response, point, comment, positionForce, addchoice, deleteChoice, tTimedQcm,edition, nbResponses) {
    ...
    container.children().first().children('div').each(function () {
        ...
        $('#ujm_exobundle_interactiontimedQcmtype_choices_'+index+'_weight').click(function() {
            $(this).focus();
        });
...
function addChoice(container, deleteChoice, comment, edition) {
    ...
    while (uniqChoiceID == false) {
        if ($('#ujm_exobundle_interactiontimedQcmtype_choices_' + index+'_label').length) {
            index++;
        } else {
            uniqChoiceID = true;
        }
...
function whichChecked() {
    ...
    if ($('#ujm_exobundle_interactiontimedQcmtype_shuffle').is(':checked')) {
    ...
    // Change the type of ExpectedAnswer (radio or checkbox) depending on which typeTimedQcm is choose
    var type = $('#ujm_exobundle_interactiontimedQcmtype_typeTimedQcm :checked').val();

    $("*[id$='_rightResponse']").each(function () {
        if (typeTimedQcm[type] == 1) {
...
function whichChange() {
    ...
    $('#ujm_exobundle_interactiontimedQcmtype_shuffle').change(function () {
        if ($(this).is(':checked')) {
            tableChoices.find('th').eq(4).show();
            $("*[id$='_positionForce']").each(function () {
                $(this).parent('td').show();
    ...
    // If state of weightResponse change, hide or display the scoreRightResponse and scoreFalseResponse fields.
    $('#ujm_exobundle_interactiontimedQcmtype_weightResponse').change(function () {
        hiddenScore();
    });

    // If state of limitedTime change, hide or display the duration field.
    $('#ujm_exobundle_interactiontimedQcmtype_limitedTime').change(function () {
        hiddenDuration();
    });

    // When "type of TimedQcm (unique/multiple)" change, change the expected response to radio or checkbox
    $('#ujm_exobundle_interactiontimedQcmtype_typeTimedQcm').change(function () {
        var type = $('#ujm_exobundle_interactiontimedQcmtype_typeTimedQcm :checked').val();
...
function fillChoicesArray(row,edition,index) {
    ...
    if (row.find('*[id$="_label"]').length) {
        ...
        $('#span_'+idLabelVal).append('<span class="input-group-btn"><a class="btn btn-default" id="btnEdition_'+idLabelVal+'" onClick="advancedEdition(\'ujm_exobundle_interactiontimedQcmtype_choices_'+index+'_label\',\'btnEdition_'+idLabelVal+'\',event);" title="'+edition+'"><i class="fa fa-font"></i></a></span>');
    }
    ...
    if (row.find('*[id$="_feedback"]').length) {
        ...
        $('#span_'+idFeedbackVal).append('<span class="input-group-btn"><a class="btn btn-default" id="btnEdition_'+idFeedbackVal+'" onClick="advancedEdition(\'ujm_exobundle_interactiontimedQcmtype_choices_'+index+'_feedback\',\'btnEdition_'+idFeedbackVal+'\',event);" title="'+edition+'"><i class="fa fa-font"></i></a></span>');
    }
}
 ...
 */
function checkScore() {
    if ($('#ujm_exobundle_interactiontimedQcmtype_weightResponse').is(':checked')) {
        if ($('#ujm_exobundle_interactiontimedQcmtype_scoreFalseResponse').val() === '') {
            $('#ujm_exobundle_interactiontimedQcmtype_scoreFalseResponse').val('~');
        }
        if ($('#ujm_exobundle_interactiontimedQcmtype_scoreRightResponse').val() === '') {
            $('#ujm_exobundle_interactiontimedQcmtype_scoreRightResponse').val('~');
        }
...
function hiddenScore() {
    if ($('#ujm_exobundle_interactiontimedQcmtype_weightResponse').is(':checked')) {
        $('#ujm_exobundle_interactiontimedQcmtype_scoreRightResponse').css({"display": "none"});
        $('#ujm_exobundle_interactiontimedQcmtype_scoreFalseResponse').css({"display": "none"});
        ...
        $('#ujm_exobundle_interactiontimedQcmtype_scoreRightResponse').css({"display": "inline-block"});
        $('#ujm_exobundle_interactiontimedQcmtype_scoreFalseResponse').css({"display": "inline-block"});
...
/**
 * Disable or not the duration field if the limitedTime radio button is checked
 */
function hiddenDuration() {
    // SIMU
    if ($('#ujm_exobundle_interactiontimedQcmtype_limitedTime').is(':checked')) {
        $('#ujm_exobundle_interactiontimedQcmtype_duration select').css({'width': "auto", "display": "inline-block"});
